...
MATH_ADD_8_8_AX .macro addr, byte
  lda \addr
  clc
  adc \byte
  sta \addr
...
MATH_ADD_16_8_AAX .macro hi, lo, byte
  lda \lo
  clc
  adc \byte
  sta \lo
...
MATH_SUB_8_8_AX .macro addr, byte
  lda \addr
  sec
  sbc \byte
  sta \addr
...
MATH_SUB_16_8_AAX .macro hi, lo, byte
  lda \lo
  sec
  sbc \byte
  sta \lo
...
MATH_MIN_16_AAXX .macro hi, lo, msb, lsb
  lda \hi
  cmp \msb
...
MATH_MAX_16_AAXX .macro hi, lo, msb, lsb
  lda \msb
  cmp \hi
